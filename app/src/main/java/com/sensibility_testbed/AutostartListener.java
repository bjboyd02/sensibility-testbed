...
///***
// *
// * Listens for a BOOT_COMPLETED intent and starts the application if
// * AUTOSTART_ON_BOOT is set
// *
// */
...
//            ScriptActivity.SEATTLE_PREFERENCES, Context.MODE_WORLD_WRITEABLE);
...
//                  "Sensibility Testbed not properly installed -- Autostart attempt failed");
//            else
